...
printf "\n${blue}[*] Instalando pacotes do NH PROGRAMMER EDITION...\n"
nh -r sudo apt install geany -y
nh -r sudo apt install bluefish -y
nh -r sudo apt install thonny -y
nh -r sudo apt install neovim -y
nh -r sudo apt install emacs -y
