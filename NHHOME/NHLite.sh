...
cd $HOME
print_banner;get_arch;set_strings;prepare_fs;check_dependencies;get_rootfs;get_sha;verify_sha;extract_rootfs;create_launcher;cleanup

printf "\n${blue}[*] Configurando NH HOME EDITION ...\n"
fix_profile_bash;fix_sudo;create_kex_launcher;fix_uid
...
nh -r sudo apt install libreoffice -y
...
nh -r chmod +x /home/kali/.vnc/xstartup /root/.vnc/xstartup

print_banner
printf "${green}[=] NetHunter para Termux instalado com sucesso${reset}\n\n"
printf "${green}[+] Para iniciar o NH Lite v2.0, digite:${reset}\n"
printf "${green}[+] nethunter                     # Para iniciar o NH Lite GUI${reset}\n"
printf "${green}[+] nh vncpasswd                  # Para definir a senha do VNC${reset}\n"
printf "${green}[+] nh vncserver                  # Para iniciar o NH Lite GUI${reset}\n"
printf "${green}[+] nh vncserver -kill :1         # Para parar o NH Lite GUI${reset}\n"
